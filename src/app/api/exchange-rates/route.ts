...
const API_URL = "https://scoreboard.argamon.com:8443/api/rebates/exchange-rates?base_currency=USD";
...
export async function GET() {
  try {
    ...
    console.error(
      "Failed to fetch exchange rates from upstream API:",
      isAborted ? "Request timed out" : err,
    );
    return NextResponse.json(
