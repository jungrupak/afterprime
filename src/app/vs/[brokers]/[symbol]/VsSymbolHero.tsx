...
export default function VsSymbolHero({
  ...
  return (
    <section
      className={`${styles.innerBannerSection} compact-innerpage-banner`}
    >
      <div className="ap_container_small flex items-center h-full">
        <div className="apBannerContent md:max-w-[860px]">
          ...
          >
            {brokerName} costs{" "}
            <strong>${compCostPerLot.toFixed(2)}/lot</strong> on {sym}.
            Afterprime costs{" "}
          ...
          <div className={styles.statPills}>
            <div
              className={`${styles.statPill} ${styles.statPillAfterPrime}`}
            >
