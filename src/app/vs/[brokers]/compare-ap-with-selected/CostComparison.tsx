...
{selectedBrokerName} costs reflect spread including commission on standard lot. Afterprime costs include zero commission with Flow Rewards™ applied at standard eligible rates. Comparisons are on a like-for-like account basis.</p>
      </div>
    </div>
  );
}
