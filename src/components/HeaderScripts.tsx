        ...
        !function(){
          ...
          if(!analytics.initialize)
            if(analytics.invoked) window.console && console.error && console.error("Segment snippet included twice.");
              ...
              analytics.factory=function(e){return function(){if(window[i].initialized)return window[i][e].apply(window[i],arguments);var n=Array.prototype.slice.call(arguments);
              if(["track","screen","alias","group","page","identify"].indexOf(e)>-1){
                var c=document.querySelector("link[rel='canonical']");

                // --- Custom Referrer Logic ---
                var ref = document.referrer;
                var isInternal = ref.indexOf("afterprime.com") !== -1;
                var externalReferrer = isInternal ? "" : ref;
                // ----------------------------
                ...
                n.push({
                  ...
                  s:location.search,
                  t:document.title,
                  r:externalReferrer // Use the filtered referrer here
                })
              }
              ...
              // Final explicit page call to ensure referrer is captured on load
              analytics.page();
            }
        }();
      `}
