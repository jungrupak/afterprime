...
export default function ProfitCalculator() {
  ...
  //Position Toggle state and value
  ...
  function resultCalc() {
    ...
    if (!instrument || !activeLotsize || !activeAskPrice || !activeBidPrice) {
    ...
    const profitCal = activeLotsize * contract * diff;
    const profit = (profitCal * fx).toFixed(2);
  ...
  }, [activeCurrency, position, isDataReady]);
          ...
          >
            ...
            <div className="md:col-span-3 col-span-4 !z-2">
              ...
              <ToggleBtn
                ...
                optionB="Sell"
                onclick={() => {
                  setPosition((prev) => (prev === "Buy" ? "Sell" : "Buy"));
                }}
              />
            </div>
